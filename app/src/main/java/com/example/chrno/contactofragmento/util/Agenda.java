...
public class Agenda {
    ...
    public Agenda(Context c){//Constructor de mi clase agenda en el que meto los contactos de mi movil en una lista
        ...
        for(Contacto aux:agenda)//recorro todos los contactos de mi agenda
            aux.setTelefonos(Agenda.getListaTelefonos(c, aux.getId()));//con un set le meto al contacto el numero de telefono
...
//        agenda.add(aux);
//    }
    public void setAgenda(List<Contacto> aux){
        agenda=aux;
//        for(Contacto a:agenda){
//            System.out.println("2--_: "+a);
//        }
    }
    public List getAgenda(){
//        for(Contacto aux:agenda){
//            System.out.println("1--_: "+aux);
//        }
        return agenda;
    }
    @Override
